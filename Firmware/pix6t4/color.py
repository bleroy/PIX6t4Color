...
Color.DARKGREY = Color(0x404040FF)
Color.ORANGE = Color(0xFFA500FF)
Color.PURPLE = Color(0x800080FF)
Color.BROWN = Color(0xA52A2AFF)
Color.PINK = Color(0xFFC0CBFF)
Color.DARKPINK = Color(0xE75480FF)
Color.LILAC = Color(0xC8A2C8FF)
Color.LIGHTBLUE = Color(0xADD8E6FF)
Color.DARKBLUE = Color(0x08038DFF)
